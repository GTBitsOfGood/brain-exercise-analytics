...
export const modifyMath = async (userID: string, questionsAttempted: Number, questionsCorrect: Number, timePerQuestion: Number, difficultyScore: Number) => {
...
export const modifyTrivia = async (userID: string, questionsAttempted: Number, questionsCorrect: Number, timePerQuestion: Number) => {
...
export const modifyReading = async (userID: string, completed: boolean, passagesRead: Number) => {
